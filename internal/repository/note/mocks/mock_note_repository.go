...
// Source: github.com/TatyanaChebotareva/Note-Service-Api/internal/repository/note (interfaces: Repository)
...
import (
	...
	model "github.com/TatyanaChebotareva/Note-Service-Api/internal/model"
...
func (m *MockRepository) GetList(arg0 context.Context) ([]*model.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *model.UpdateNoteInfo) error {
	m.ctrl.T.Helper()
